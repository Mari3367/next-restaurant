  ...
  return (
    <div>
        ...
        <div className="flex flex-col gap-8 md:flex-row items-center justify-between">
            ...
            <Link href="" onClick={() => signOut()} className="cursor-pointer xl:text-lg group text-green-600 transition-all duration-300 ease-in-out">
            ...
            <p className="text-white">
             ...
             <Link href={"/auth/signin"} onClick={() => signIn()} className="group text-green-600 transition-all duration-300 ease-in-out">
